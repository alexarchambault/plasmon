// Originally based on https://github.com/scalameta/metals/blob/2a6f8a437a1ce7c44140673edfe34bb74dfd33be/metals/src/main/scala/scala/meta/internal/metals/JavaFormattingProvider.scala or an earlier version of that file
...
final class JavaFormattingProvider(
  ...
  private def runFormat(
    ...
    if (
      ...
      val version = for {
        targetID      <- bspData.sourceBuildTargets(path).toList.flatten
        java          <- bspData.javaTarget(targetID)
